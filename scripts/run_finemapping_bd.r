#!/usr/bin/env Rscript
# =============================================================================
# Fine-Mapping Pipeline — SCZ vs BD
# SuSiE-RSS (L=5) + FINEMAP-SSS (k=5) for 12 BD loci
...
# ── Paths ────────────────────────────────────────────────────────────────────
DATADIR     <- "C:/PGC4"
LDDIR       <- file.path(DATADIR, "ld/sczvsbp")
SUSIEDIR    <- file.path(DATADIR, "r_files/sczvsbp/susie")
FMDIR       <- file.path(DATADIR, "r_files/sczvsbp/finemap")
SUMSTATS    <- file.path(DATADIR, "sumstats/daner_scz_vs_bip_1025_noduppos_hetpva.gz")
