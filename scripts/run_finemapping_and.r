...
# ── Paths ────────────────────────────────────────────────────────────────────
DATADIR     <- "C:/PGC4"
LDDIR       <- file.path(DATADIR, "ld/sczandbp")
SUSIEDIR    <- file.path(DATADIR, "r_files/sczandbp/susie")
FMDIR       <- file.path(DATADIR, "r_files/sczandbp/finemap")
SUMSTATS    <- file.path(DATADIR, "sumstats/daner_scz_bip_vs_allcontrols_1025_noduppos_hetpva.gz")
